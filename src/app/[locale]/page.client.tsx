      ...
      <div className="max-w-xl mx-auto">
        <div className="bg-card text-card-foreground rounded-2xl shadow-xl p-8 border border-border relative overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center gap-6 relative z-10">
            {/* Enhanced spinner with double border */}
            <div className="relative">
              <div className="w-20 h-20 border-4 border-primary/30 border-t-primary rounded-full animate-spin"></div>
              <div className="absolute inset-0 w-20 h-20 border-4 border-transparent border-r-secondary/70 rounded-full animate-spin" style={{ animationDuration: '1.5s', animationDirection: 'reverse' }}></div>
            </div>
            
            <div className="text-center">
              <h3 className="text-xl font-semibold mb-2 gradient-text">{t('processing')}</h3>
            ...
            <div className="w-full space-y-3 mt-4">
              ...
              <div className="w-full h-2 bg-muted rounded-full overflow-hidden relative">
                <div className="absolute inset-0 animate-shimmer" style={{ opacity: 0.3 }}></div>
              </div>
            </div>
